...
const ProcessOrder = ({match, history}) => {
    ...
    const shippingDetails = shippingInfo && `${shippingInfo.address}, ${shippingInfo.city}, ${shippingInfo.usState}, ${shippingInfo.zipCode}`
                                            ...
                                            {orderItems && orderItems.map(item => (
                                                <div className="row my-5" key={item.product}>
                                                    ...
                                                    <div className="col-5 col-lg-5">
                                                        <Link to={`/prodect/${item.product}`}>{item.name}</Link>
                                                    </div>
